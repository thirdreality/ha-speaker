...
$(info SPEAKER_FIRMWARE_VERSION: $(SPEAKER_FIRMWARE_VERSION))
...
# define UPDATE-ZIP-PACK
# 	$(INSTALL) -m 0755 package/amlogic/aml-uac/aml_update_zip_creat.sh $(HOST_DIR)/usr/bin/
# 	$(HOST_DIR)/usr/bin/aml_update_zip_creat.sh $(BINARIES_DIR)
# endef
# ROOTFS_UBI_POST_GEN_HOOKS += UPDATE-ZIP-PACK
# endif

# TODO:GE
# If anti-rollback is enabled need to write the ota version here.
