...
# Apply the related patch if gstdrmbuffer is enabled
ifeq ($(BR2_PACKAGE_GST_AML_DRMBUFFERPOOL1),y)
GST1_PLUGINS_BAD_DEPENDENCIES += gst-aml-drmbufferpool1
define GST1_PLUGINS_BAD_APPLY_GSTDRMBUFFER_PATCHES
	$(APPLY_PATCHES) $(@D) $(GST1_PLUGINS_BAD_PKGDIR)/gstdrmbuffer *.patch;
endef
GST1_PLUGINS_BAD_POST_PATCH_HOOKS += GST1_PLUGINS_BAD_APPLY_GSTDRMBUFFER_PATCHES
endif
