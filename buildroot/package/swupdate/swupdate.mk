...
ifdef BR2_PACKAGE_EXTRA_SWUPDATE_PATCH
define SWUPDATE_APPLY_COMMON_PATCHES
  if [ -d $(BR2_PACKAGE_EXTRA_SWUPDATE_PATCH) ]; then \
		echo extra patch for swupdate; \
		$(APPLY_PATCHES) $(@D) $(BR2_PACKAGE_EXTRA_SWUPDATE_PATCH) *.patch; \
  fi
endef
SWUPDATE_POST_PATCH_HOOKS += SWUPDATE_APPLY_COMMON_PATCHES
endif
