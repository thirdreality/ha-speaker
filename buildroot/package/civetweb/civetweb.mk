...
define CIVETWEB_INSTALL_TARGET_CMDS
	...
	$(TARGET_CONFIGURE_OPTS) $(MAKE) -C $(@D) $(CIVETWEB_INSTALL_TARGETS) \
		...
		$(CIVETWEB_CONF_OPTS) \
		COPT='$(CIVETWEB_COPT)'
	$(INSTALL) -D -m 0755 $(CIVETWEB_PKGDIR)/S43civetweb $(TARGET_DIR)/etc/init.d/S43civetweb
	$(INSTALL) -D -m 0644 $(CIVETWEB_PKGDIR)/civetweb.conf $(TARGET_DIR)/etc/civetweb.conf
endef
