...
# android-tools 5 doesn't need usb_monitor
ifeq ($(BR2_PACKAGE_ANDROID_TOOLS5), y)
	SHOULD_USE_USB_MONITOR=n
else
	SHOULD_USE_USB_MONITOR=y
endif

define AML_UTIL_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) -C $(@D) CFLAGS="$(AML_UTIL_PRIV_FLAGS)" \
		USE_UAC_HID=$(BR2_UTILS_UAC_HID) \
		USE_SIMULATE_KEY=$(BR2_AML_UTIL_SIMULATE_KEY) \
		USE_AUTO_SHUTDOWN=$(BR2_UTILS_AUTO_SHUTDOWN) \
		USE_BATTERY_MONITOR=$(BR2_UTILS_BATTERY_MONITOR) \
		USE_USB_MONITOR=$(SHOULD_USE_USB_MONITOR) \
		all
