...
define SOX_INSTALL_TARGET_CMDS
	install -m 755 $(TOPDIR)/../toolchain/gcc/linux-x86/arm/gcc-arm-10.3-2021.07-x86_64-arm-none-linux-gnueabihf/arm-none-linux-gnueabihf/lib/libgomp.so.1 $(TARGET_DIR)/usr/lib/
	install -m 755 $(TARGET_DIR)/../build/sox-14.4.2/src/sox $(TARGET_DIR)/usr/bin/
	install -m 755 $(TARGET_DIR)/../build/sox-14.4.2/src/.libs/libsox.so.3 $(TARGET_DIR)/usr/lib/
endef
