...
ifeq ($(BR2_TOOLCHAIN_EXTERNAL_LIBCPP),y)
TOOLCHAIN_EXTERNAL_LIBS += libc++.so.* libc++abi.so*
endif
...
define TOOLCHAIN_EXTERNAL_INSTALL_SYSROOT_DEBUG_VERSION_crtn
	$(Q)$(call MESSAGE,"Copying debug version crtn.o")
	$(Q)SYSROOT_DIR="$(call toolchain_find_sysroot,$(TOOLCHAIN_EXTERNAL_CC))" ; \
	if [ -f "$${SYSROOT_DIR}/usr/lib/crtn-debug.o" ] ; then \
		cp "$${SYSROOT_DIR}/usr/lib/crtn-debug.o" "$${STAGING_DIR}/usr/lib/crtn.o" ; \
	fi
endef
endif
...
define $(2)_INSTALL_STAGING_CMDS
	...
	$$(TOOLCHAIN_EXTERNAL_INSTALL_SYSROOT_DEBUG_VERSION_crtn)
